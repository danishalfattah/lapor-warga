  ...
  return (
    <Dialog open={open} onOpenChange={onClose}>
      <DialogContent className="max-w-2xl">
        <DialogHeader>
          <DialogTitle className="text-2xl text-[#1E293B]">
            Buat Laporan Baru
          </DialogTitle>
        </DialogHeader>
        ...
        <form onSubmit={handleSubmit} className="space-y-4 mt-4">
          ...
          <div>
            <Label htmlFor="location">Lokasi Singkat</Label>
            <Input
              id="location"
          ...
          <div>
            ...
            <div className="border-2 border-dashed border-gray-300 rounded-lg p-8 text-center hover:border-[#FACC15] transition-colors cursor-pointer">
